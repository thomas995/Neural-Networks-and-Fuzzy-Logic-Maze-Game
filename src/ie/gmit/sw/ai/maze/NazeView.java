...
import javax.swing.*;
public class NazeView extends JPanel implements ActionListener{
	...
	public NazeView(Nade[][] maze, Nade goal) {
		this.maze = maze;
	...
	public void paintComponent(Graphics g) {
        ...
        g2.drawRect(0, 0, NazeView.DEFAULT_VIEW_SIZE, NazeView.DEFAULT_VIEW_SIZE);
