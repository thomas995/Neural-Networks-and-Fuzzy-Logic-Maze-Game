...
public abstract class AbstractMazeGenerator implements MazeGenerator {
	...
	protected void shuffle(Nade[] nodes){
	...
	protected Direction getDirection(Nade current, Nade adjacent){
	...
	public String toString() {
		...
		for (int row = 0; row < maze.length; row++){
			for (int col = 0; col < maze[row].length; col++){
				Nade.Direction[] dirs = maze[row][col].getPaths();
				sb.append("(");
